...
interface SortableChipsContentProps {
  tags: Tag[];
  onReorder: (tags: Tag[]) => void;
  onDelete: (id: string) => void;
}

function SortableChipsContent({ tags, onReorder, onDelete }: SortableChipsContentProps) {
  useDndMonitor({
...
export default function DraggableChips() {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 500 }}>
      ...
      <DndContext>
        <SortableChipsContent tags={tags} onReorder={setTags} onDelete={handleDelete} />
      </DndContext>
    </Box>
  );
}
