...
interface SortableGridContentProps {
  cards: DashboardCard[];
  onReorder: (cards: DashboardCard[]) => void;
}

function SortableGridContent({ cards, onReorder }: SortableGridContentProps) {
  useDndMonitor({
...
export default function DraggableGrid() {
  ...
  return (
    <DndContext>
      <SortableGridContent cards={cards} onReorder={setCards} />
    </DndContext>
  );
}
