...
interface SortableTableContentProps {
  rows: Person[];
  onReorder: (rows: Person[]) => void;
}

function SortableTableContent({ rows, onReorder }: SortableTableContentProps) {
  useDndMonitor({
...
export default function DraggableTable() {
  ...
  return (
    <DndContext>
      <SortableTableContent rows={rows} onReorder={setRows} />
    </DndContext>
  );
}
